...
4. UT -->
5. e2e tests. --> added work in progress

6. add data to backend server. use node.js --> done
7. finally move the data to backend, lets use mongodb.
8. Add few animations.
9. Alternative view? may be a card view.
10. get rid of $http and use the higher level abstraction called $resource. Might get to use $q as well from the core. --> Done
11. filter based on name only. right now it takes email etc also in to account. --> Done
...
14. Improve the structure of overall app. May be divide in modules and have nice hierarchy.
15. Add grunt tasks for unit tests and e2e tests.
16. Responsive design, the app should scale well on all screen sizes.
